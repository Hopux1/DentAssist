...
namespace DentAssist.Controllers
{
    public class TratamientosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Nombre,Descripcion,Precio")] Tratamiento tratamiento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nombre,Descripcion,Precio")] Tratamiento tratamiento)
        {
